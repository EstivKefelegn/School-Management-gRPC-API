...
func (x *ExecLoginRequest) GetStatus() bool {
	if x != nil {
		return x.Status
	}
	return false
...
func (x *ExecLoginRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
type ExecLoginResponse struct {
	...
	Pssword       string                 `protobuf:"bytes,2,opt,name=pssword,proto3" json:"pssword,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExecLoginResponse) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *ExecLoginResponse) GetPssword() string {
	if x != nil {
		return x.Pssword
	}
	return ""
...
func (x *GetExecsRequest) GetSortField() []*SortField {
	if x != nil {
		return x.SortField
	}
	return nil
...
type Exec struct {
	...
	PasswordResetAt      string                 `protobuf:"bytes,9,opt,name=password_reset_at,json=passwordResetAt,proto3" json:"password_reset_at,omitempty"`
	...
	PasswordTokenExpires string                 `protobuf:"bytes,11,opt,name=password_token_expires,json=passwordTokenExpires,proto3" json:"password_token_expires,omitempty"`
	Role                 string                 `protobuf:"bytes,12,opt,name=role,proto3" json:"role,omitempty"`
	InactiveStatus       bool                   `protobuf:"varint,13,opt,name=inactive_status,json=inactiveStatus,proto3" json:"inactive_status,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *Exec) GetPasswordResetAt() string {
	if x != nil {
...
const file_execs_proto_rawDesc = "" +
	...
	"\aExecIds\x12\x1e\n" +
	"\x03ids\x18\x01 \x03(\v2\f.main.ExecIdR\x03ids\"\x9e\x01\n" +
	...
	"\x0fuser_created_at\x18\b \x01(\tR\ruserCreatedAt\x12*\n" +
	"\x11password_reset_at\x18\t \x01(\tR\x0fpasswordResetAt\x120\n" +
	"\x14password_reset_token\x18\n" +
	" \x01(\tR\x12passwordResetToken\x124\n" +
	"\x16password_token_expires\x18\v \x01(\tR\x14passwordTokenExpires\x12\x12\n" +
...
var file_execs_proto_goTypes = []any{
	...
	(*ExecLogoutResponse)(nil),      // 5: main.ExecLogoutResponse
	(*ExecLoginRequest)(nil),        // 6: main.ExecLoginRequest
	(*ExecLoginResponse)(nil),       // 7: main.ExecLoginResponse
	(*UpdatePasswordRequest)(nil),   // 8: main.UpdatePasswordRequest
...
var file_execs_proto_depIdxs = []int32{
	...
	6,  // 8: main.ExecsService.Login:input_type -> main.ExecLoginRequest
	9,  // 9: main.ExecsService.Logout:input_type -> main.EmptyRequest
	8,  // 10: main.ExecsService.UpdatePassword:input_type -> main.UpdatePasswordRequest
	...
	7,  // 18: main.ExecsService.Login:output_type -> main.ExecLoginResponse
	5,  // 19: main.ExecsService.Logout:output_type -> main.ExecLogoutResponse
