...
func (x *GetTeachersRequest) GetSortField() []*SortField {
	if x != nil {
		return x.SortField
	}
	return nil
...
const file_main_proto_rawDesc = "" +
	...
	"\n" +
	"TeacherIds\x12!\n" +
	"\x03ids\x18\x01 \x03(\v2\x0f.main.TeacherIdR\x03ids\"l\n" +
	"\x12GetTeachersRequest\x12'\n" +
	"\ateacher\x18\x01 \x01(\v2\r.main.TeacherR\ateacher\x12-\n" +
	"\tsortField\x18\x02 \x03(\v2\x0f.main.SortFieldR\tsortField\"\x9b\x01\n" +
	"\aTeacher\x12\x0e\n" +
	...
	"\x1fGetStudentsCountByClassTeachers\x12\x0f.main.TeacherId\x1a\x12.main.StudentCountB\x16Z\x14/proto/gen;grpcapipbb\x06proto3"
...
var file_main_proto_depIdxs = []int32{
	...
	7,  // 2: main.GetTeachersRequest.sortField:type_name -> main.SortField
	...
	2,  // 9: main.TeachersService.GetStudentsCountByClassTeachers:input_type -> main.TeacherId
	...
	0,  // 15: main.TeachersService.GetStudentsCountByClassTeachers:output_type -> main.StudentCount
