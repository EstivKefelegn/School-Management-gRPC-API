...
func (x *GetStudentsRequest) GetSortField() []*SortField {
	if x != nil {
		return x.SortField
	}
	return nil
...
const file_students_proto_rawDesc = "" +
	...
	"\n" +
	"StudentIds\x12!\n" +
	"\x03ids\x18\x01 \x03(\v2\x0f.main.StudentIdR\x03ids\"\xaa\x01\n" +
...
var file_students_proto_depIdxs = []int32{
	...
	6, // 1: main.GetStudentsRequest.student:type_name -> main.Student
	5, // 2: main.GetStudentsRequest.sortField:type_name -> main.SortField
