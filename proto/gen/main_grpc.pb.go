...
type TeachersServiceClient interface {
	...
	GetStudentsCountByClassTeachers(ctx context.Context, in *TeacherId, opts ...grpc.CallOption) (*StudentCount, error)
}
...
func (c *teachersServiceClient) GetStudentsCountByClassTeachers(ctx context.Context, in *TeacherId, opts ...grpc.CallOption) (*StudentCount, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TeachersServiceServer interface {
	...
	GetStudentsCountByClassTeachers(context.Context, *TeacherId) (*StudentCount, error)
...
func (UnimplementedTeachersServiceServer) GetStudentsCountByClassTeachers(context.Context, *TeacherId) (*StudentCount, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetStudentsCountByClassTeachers not implemented")
}
...
func _TeachersService_GetStudentsCountByClassTeachers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeachersServiceServer).GetStudentsCountByClassTeachers(ctx, req.(*TeacherId))
	}
	return interceptor(ctx, in, info, handler)
}
